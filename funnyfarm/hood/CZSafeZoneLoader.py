...
class CZSafeZoneLoader:
	def __init__(self, loaderClass):
		self.loaderClass = loaderClass
		self.playgroundFile = 'phase_14/models/neighborhoods/FF_central.bam'
		self.musicFile = 'phase_13/audio/bgm/party_swing_dance.ogg'
		self.skyFile = 'phase_3.5/models/props/TT_sky.bam'
		self.spookySkyFile = 'phase_3.5/models/props/BR_sky.bam'
	
	def load(self):
		self.centralZone = self.loaderClass.loadModel(self.playgroundFile)
		self.centralZone.reparentTo(render)
