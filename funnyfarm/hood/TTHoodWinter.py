...
class TTHoodWinter(DirectObject):

	def __init__(self, dnaStore):
		self.dnaStore = dnaStore
		self.id = ToontownGlobals.ToontownCentral
		...
		self.safeZoneFile = 'phase_4/dna/toontown_central_sz.dna'
	...
	def __fixHood(self):
		...
		self.hq = self.geom.find('**/sz20:toon_landmark_hqTT_DNARoot')
