...
from funnyfarm.toontowngui.LoadingScreen import ToontownLoadingScreen
...
class FunnyFarmLoader(Loader.Loader):
    ...
    def __init__(self, base):
        ...
        self.blockName = None
        self.loadingScreen = ToontownLoadingScreen()
        return
    ...
    def beginBulkLoad(self, name, label, range, zoneId):
        ...
        self.blockName = name
        self.loadingScreen.begin(range, label, zoneId)
        return None
