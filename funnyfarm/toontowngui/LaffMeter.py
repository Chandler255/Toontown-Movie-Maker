...
class LaffMeter(DirectFrame):
    ...
    def load(self):
        ...
        if self.isToon:
            hType = base.localAvatar.species
            if hType == 'dog':
            ...
            self.color = base.localAvatar.headColorIndex
            ...
            self.maxLabel = DirectLabel(parent=self.eyes, relief=None, pos=(0.442, 0, 0.051), text='120', text_scale=0.4, text_font=loader.loadFont('phase_3/models/fonts/ImpressBT.ttf'))
            self.hpLabel = DirectLabel(parent=self.eyes, relief=None, pos=(-0.398, 0, 0.051), text='120', text_scale=0.4, text_font=loader.loadFont('phase_3/models/fonts/ImpressBT.ttf'))
